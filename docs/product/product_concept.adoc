...
Die meisten Cocktailbars öffnen erst am Abend und verkaufen ihre Cocktails nicht online. Dadurch verpassen Sie mögliche Gewinne. Die Organisation und Abwicklung des Bestellvorgangs ist mit viel Aufwand verbunden. Eine einfache Lösung fehlt bis jetzt.
...
| private Feiern
| Die Gäste wollen leckere Cocktails haben
| einfache Auswahl, Bestellung und Lieferung der Cocktails
| Hoch

| Großveranstaltungen
| Viele Gäste müssen mit Cocktails versorgt werden
| einfache/unkomplizierte Bestellung und Lieferung von großen Mengen von Cocktails
| Hoch

| Privatperson
| Bestellung eines Cocktails
| mobile Anwendung (z. B. App)
| Niedrig
...
| Cocktailbarbetreiber
| Entscheider, Käufer/Kunde
| einfache Verwaltung und Abwicklung von Bestellungen
|
...
| Entwickler + Betreiber (unser Startup)
|
|
|
